...
void Graph::_import_from_file(const string& input_file_name) {
	...
	while (ifs >> start_vertex) {
		...
		// all the node operation is operated by node pointer
...
//first adjust the node whether exists, then allocate the pointer for the node
